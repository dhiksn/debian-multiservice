...
Write-Host "Generating install.sh..." -ForegroundColor Cyan
...
# Fix line endings to LF (Unix-style)
$content = [System.IO.File]::ReadAllText($outputPath) -replace "`r`n", "`n" -replace "`r", "`n"
[System.IO.File]::WriteAllText((Resolve-Path $outputPath).Path, $content, [System.Text.Encoding]::UTF8)

Write-Host ""
Write-Host "✅ install.sh berhasil digenerate!" -ForegroundColor Green
Write-Host ""
Write-Host "📋 Informasi File:" -ForegroundColor Cyan
Write-Host "   Path    : $(Resolve-Path $outputPath)" -ForegroundColor White
Write-Host "   Size    : $((Get-Item $outputPath).Length) bytes" -ForegroundColor White
Write-Host ""
Write-Host "🚀 Cara penggunaan di Debian:" -ForegroundColor Yellow
Write-Host "   1. Transfer install.sh ke server Debian" -ForegroundColor White
Write-Host "   2. chmod +x install.sh" -ForegroundColor White
Write-Host "   3. sudo bash install.sh" -ForegroundColor White
Write-Host ""