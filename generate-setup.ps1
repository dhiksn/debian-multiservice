...
# Fungsi: Generate bash script untuk Debian server setup
...
Write-Host "==========================================================================" -ForegroundColor Yellow
Write-Host ""
Write-Host "1. Transfer ke server Debian:" -ForegroundColor White
Write-Host "   scp test.sh root@server-ip:/root/" -ForegroundColor Gray
Write-Host ""
Write-Host "2. Jalankan:" -ForegroundColor White
Write-Host "   chmod +x test.sh" -ForegroundColor Gray
Write-Host "   ./test.sh" -ForegroundColor Gray
Write-Host ""
Write-Host "==========================================================================" -ForegroundColor Green
