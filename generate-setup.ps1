...
# Generate file test.sh dengan encoding UTF-8
$outputPath = ".\test.sh"
...
Write-Host "File yang dihasilkan: test.sh" -ForegroundColor Cyan
$fileInfo = Get-Item $outputPath
Write-Host "Ukuran file: $([math]::Round($fileInfo.Length/1KB, 2)) KB" -ForegroundColor Cyan
$lineCount = ($setupScriptContent -split "`n").Count
Write-Host "Total baris: $lineCount" -ForegroundColor Cyan
...
Write-Host "============================================================" -ForegroundColor Yellow
Write-Host ""
Write-Host "1. Transfer file ke server Debian:" -ForegroundColor White
Write-Host "   scp test.sh user@server-ip:/home/user/" -ForegroundColor Gray
Write-Host ""
Write-Host "2. Set permission execute:" -ForegroundColor White
Write-Host "   chmod +x test.sh" -ForegroundColor Gray
Write-Host ""
Write-Host "3. Jalankan sebagai root:" -ForegroundColor White
Write-Host "   sudo ./test.sh" -ForegroundColor Gray
Write-Host ""

Write-Host "============================================================" -ForegroundColor Magenta
Write-Host "                   FITUR YANG TERSEDIA                      " -ForegroundColor Magenta
Write-Host "============================================================" -ForegroundColor Magenta
Write-Host ""
Write-Host "[+] Banner TECHCORP dengan animasi warna" -ForegroundColor Green
Write-Host "[+] Menu interaktif dengan 6 pilihan" -ForegroundColor Green
Write-Host "[+] Konfigurasi IP Static + DNS" -ForegroundColor Green
Write-Host "[+] Install Apache2 dengan halaman web modern" -ForegroundColor Green
Write-Host "[+] Install vsftpd dengan user admin" -ForegroundColor Green
Write-Host "[+] Install SSH dengan key-based authentication" -ForegroundColor Green
Write-Host "[+] Logging berwarna (INFO, ERROR, WARNING, SUCCESS)" -ForegroundColor Green
Write-Host "[+] Modular functions (mudah dikembangkan)" -ForegroundColor Green
Write-Host "[+] Backup otomatis konfigurasi asli" -ForegroundColor Green
Write-Host ""

Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "              INFORMASI DEFAULT CREDENTIAL                  " -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "FTP User:     admin" -ForegroundColor Yellow
Write-Host "FTP Password: 123" -ForegroundColor Yellow
Write-Host "SSH User:     admin" -ForegroundColor Yellow
Write-Host "SSH Auth:     Key-based (password disabled)" -ForegroundColor Yellow
Write-Host ""
