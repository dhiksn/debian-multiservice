# PowerShell Script: Generate-DebianSetup.ps1
# Fungsi: Generate bash script untuk instalasi multi-service di Debian
# Output: setup.sh

# Definisikan konten setup.sh
$setupScriptContent = @'
#!/bin/bash
...
EOF
    echo -e "${NC}"
    echo -e "${CYAN}${BOLD}  â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”${NC}"
    echo -e "${CYAN}${BOLD}  â”‚   Multi-Service Installer | Apache2 + vsftpd + OpenSSH â”‚${NC}"
    echo -e "${CYAN}${BOLD}  â”‚              Target OS: Debian Latest                  â”‚${NC}"
...
# Generate file setup.sh
$outputPath = Join-Path $PSScriptRoot "setup.sh"

# Write file dengan encoding UTF8 without BOM
$utf8NoBom = New-Object System.Text.UTF8Encoding $false
[System.IO.File]::WriteAllText($outputPath, $setupScriptContent, $utf8NoBom)

Write-Host ""
Write-Host "========================================" -ForegroundColor Green
Write-Host "Setup script berhasil dihasilkan!" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
Write-Host "File yang dihasilkan: $outputPath" -ForegroundColor Cyan
Write-Host ""
Write-Host "Cara menggunakan:" -ForegroundColor Yellow
Write-Host "1. Transfer file ke server Debian" -ForegroundColor White
Write-Host "2. chmod +x setup.sh" -ForegroundColor White
Write-Host "3. sudo ./setup.sh" -ForegroundColor White
Write-Host ""
...
if (Test-Path $outputPath) {
    ...
    Write-Host "Error: File gagal dibuat!" -ForegroundColor Red
}
Write-Host ""
